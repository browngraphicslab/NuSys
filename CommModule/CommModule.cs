...
namespace CommModule
{
    ...
    public sealed class CommModule : IDisposable
    {
        ...
        public void Reset()
        {
            lock (this)
            {
                if (readPacket != null)
                {
                    ...
                    {
                        Debug.WriteLine("Could not detach DataReader: " + exp.Message);
                    }
                }
                ...
                if (writePacket != null)
                {
                    ...
                    {
                        Debug.WriteLine("Could not detach DataWriter: " + exp.Message);
                    }
                }
                ...
                Debug.WriteLine("CommModule has been reset.");
            }
        }
        ...
        async Task<bool> RegisterWithCCTHelper(string serverUri)
        {
            ...
            Debug.WriteLine("RegisterWithCCTHelper Starting...");
            ControlChannelTriggerStatus status;
            Debug.WriteLine("Create ControlChannelTrigger ...");
            ...
            {
                Debug.WriteLine("Please add the app to the lock screen." + exp.Message);
                return result;
            }
            ...
            Debug.WriteLine("Calling UsingTransport() ...");
            try
            {
                ...
                Debug.WriteLine("WaitForPushEnabled() completed with status: " + status);
                ...
                var appContext = new AppContext2(this, socket, channel, channel.ControlChannelTriggerId);
                ((IDictionary<string, object>)CoreApplication.Properties).Add(channel.ControlChannelTriggerId, appContext);
                result = true;
                Debug.WriteLine("RegisterWithCCTHelper Completed.");
        ...
        public bool SetupTransport(string serviceUri)
        {
            ...
            lock (this)
            {
                ...
                if (result == false)
                {
                    Debug.WriteLine("Failed to sign on and connect");
                    if (socket != null)
                    {
                        socket.Dispose();
                        socket = null;
        ...
        {
            Debug.WriteLine("OnDataReadCompletion Entry");
            if (readPacket == null)
            {
            ...
            AppContext2.messageQueue.Enqueue(message);

            // Post another receive to ensure future push notifications.
            PostSocketRead(MAX_BUFFER_LENGTH);
            Debug.WriteLine("OnDataReadCompletion Exit");
        }

        void PostSocketRead(int length)
        {
            Debug.WriteLine("Entering PostSocketRead");
            ...
            Debug.WriteLine("Leaving PostSocketRead");
        }
        ...
        public async void SendMessage(string message)
        {
            if (socket == null)
            {
                Debug.WriteLine("Please setup connection with the server first.");
                return;
            }
            try
            {
                ...
                Debug.WriteLine("Sending message to server: " + message);
            ...
            {
                Debug.WriteLine("failed to write into the streamwebsocket: " + exp.Message);
            }
        }
    ...
    {
        public AppContext2(CommModule commInstance, StreamWebSocket webSocket, ControlChannelTrigger channel, string id)
        {
