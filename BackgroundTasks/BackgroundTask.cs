...
namespace BackgroundTasks
{
    ...
    public sealed class KATask : IBackgroundTask
    {
        public void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            if (taskInstance == null)
            {
                Debug.WriteLine("KATask: taskInstance was null");
                return;
            }

            Debug.WriteLine("KATask " + taskInstance.Task.Name + " Starting...");
            ...
            if (((IDictionary<string, object>)CoreApplication.Properties).ContainsKey(channelId))
            {
                ...
                {
                    Debug.WriteLine("KA Task failed with: " + exp.Message);
                }
            }
            else
            {
            ...
            Debug.WriteLine("KATask " + taskInstance.Task.Name + " finished.");
        }
    }
