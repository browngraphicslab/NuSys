...
namespace LdaLibrary
{
    ...
    {   
        ...
        public async Task<string> removeStopWords(string line)
        {
            ...
            Regex rgx = new Regex("[^a-zA-Z0-9 ]"); // keep just alphanumeric characters
            finalString = rgx.Replace(finalString, "");
