...
namespace NusysServer
{
    ...
    public class RequestToSqlKeyMappings
    {
        ...
        public static readonly Dictionary<string, string> LibraryElementMapping = new BiDictionary<string, string>()
        {
            ...
            {NusysConstants.NEW_LIBRARY_ELEMENT_REQUEST_SHAPED_COLLECTION_IMAGE_BACKGROUND_KEY, NusysConstants.COLLECTION_LIBRARY_ELEMENT_MODEL_SHAPE_IMAGE_BACKGROUND }, // image
