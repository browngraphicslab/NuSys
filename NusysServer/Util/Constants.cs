        ...
        public static string WWW_ROOT {
            get
            {
                switch (user)
                {
                    ...
                    case "trent":
                        return Directory.Exists("C:/Users/nusys/Desktop/NuRepoTest/") ? @"C:\Users\nusys\Desktop\Leandro NEW SIS\nusys\NusysServer\" : "D:/home/site/wwwroot/";
                    case "harsh":
        ...
        public static string FILE_FOLDER
        {
            get
            {
                switch (user)
                {
                    ...
                    case "trent":
                        return Directory.Exists(@"C:\Users\nusys\Desktop\NuRepoTest") ? @"C:\Users\nusys\Desktop\NuRepoTest" : "D:/home/site/wwwroot/files/";
                    case "harsh":
