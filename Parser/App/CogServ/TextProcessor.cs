...
namespace Parser
{
    ...
    public static class TextProcessor
    {
        ...
        public static async Task<CognitiveApiTopicModel> GetTextTopicsAsync(List<CognitiveApiDocument> documents, List<string> stopWords = null, List<string> topicsToExclude = null)
        {
            ...
            string json = Message.Serialize(jsonData);
            ...
            return Message.Deserialize<CognitiveApiTopicModel>(responseContent);
        }
        ...
        private static async Task<HttpResponseMessage> GetProcessDataAsync(string processURI, int numQueries = 30)
        {
            ...
            while (queries < numQueries)
            {
                ...
                var dict = Message.Deserialize<Dictionary<string, object>>(s);
