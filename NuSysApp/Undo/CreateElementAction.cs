...
namespace NuSysApp
{
    ...
    public class CreateElementAction : IUndoable
    {
        ...
        {
            _elementController.LibraryElementController.AddElementAtPosition(_position.X, _position.Y, null, 
                _elementController.Model.Width, _elementController.Model.Height);
