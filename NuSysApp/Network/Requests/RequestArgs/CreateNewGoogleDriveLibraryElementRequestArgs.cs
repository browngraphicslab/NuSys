...
namespace NuSysApp
{
    ...
    /// </summary>
    public class CreateNewGoogleDriveLibraryElementRequestArgs : CreateNewLibraryElementRequestArgs
    {
        public CreateNewGoogleDriveLibraryElementRequestArgs()
        {
            LibraryElementType = NusysConstants.ElementType.GoogleDrive;
        }
