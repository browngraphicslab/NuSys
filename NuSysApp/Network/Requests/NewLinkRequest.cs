...
namespace NuSysApp
{
    public class NewLinkRequest : Request
    {
        ...
        public NewLinkRequest(string id1, string id2, string creator, string contentId, LinkedTimeBlock block, RectangleView rectangle, Dictionary<string, object> inFineGrainDictionary, Dictionary<string, object> outFineGrainDictionary, string id = null) : base(RequestType.NewLinkRequest)
        {
            _message["id1"] = id1;
            _message["id2"] = id2;
