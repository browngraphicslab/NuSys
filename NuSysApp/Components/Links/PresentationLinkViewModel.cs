...
namespace NuSysApp
{
    public class PresentationLinkViewModel : BaseINPC, INuSysDisposable, ISelectable
    {
        ...
        public PresentationLinkViewModel(PresentationLinkModel model) 
        {
            ...
            Debug.Assert(model?.OutElementId != null && SessionController.Instance.ElementModelIdToElementController.ContainsKey(model.OutElementId));
            Debug.Assert(model?.InElementId != null && SessionController.Instance.ElementModelIdToElementController.ContainsKey(model.InElementId));

            _inElementController = SessionController.Instance.ElementModelIdToElementController[model.OutElementId];
            _outElementController = SessionController.Instance.ElementModelIdToElementController[model.InElementId];
        ...
        public bool IsSelected
        {
            ...
            set
            {
                ...
                Color = _selected ? _selectedColor : _notSelectedColor;
