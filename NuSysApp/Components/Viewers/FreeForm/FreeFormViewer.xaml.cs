...
namespace NuSysApp
{
    ...
    public sealed partial class FreeFormViewer
    {
        ...
        private void CollectionInteractionManagerOnResizerDragged(CanvasPointer pointer, Vector2 point, Vector2 delta, NodeResizerRenderItem.ResizerPosition resizerPosition)
        {
        ...
        /// </summary>
        public void ShowFullScreenImage(List<Uri> imageUris, int index, bool pages, Windows.Foundation.Point localPoint, Size localSize)
        {
            UITask.Run(delegate
            {
