...
namespace NuSysApp
{
    public sealed partial class GroupNodeExpandedDefaultView : AnimatableUserControl
    {
        ...
        public GroupNodeExpandedDefaultView(ElementCollectionController controller)
        {
            ...
            freeFormView = new AreaNodeView(new AreaNodeViewModel(controller));

            timelineView = new GroupNodeTimelineView(new GroupNodeTimelineViewModel(controller));
            dataGridView = new GroupNodeDataGridView(new GroupNodeDataGridViewModel(controller));
