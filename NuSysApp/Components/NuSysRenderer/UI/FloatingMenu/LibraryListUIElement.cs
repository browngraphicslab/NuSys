...
namespace NuSysApp
{
    public class LibraryListUIElement : ResizeableWindowUIElement
    {
        ...
        public void InitializeLibraryList()
        {
            ...
            LibraryListView.AddColumnOptions(new List<ListColumn<LibraryElementModel>> { imgColumn, listColumn1, listColumn2, listColumn3, listColumn4, listColumn5, listColumn6 });
