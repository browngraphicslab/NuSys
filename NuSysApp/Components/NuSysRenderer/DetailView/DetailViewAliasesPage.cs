...
namespace NuSysApp
{
    internal class DetailViewAliasesPage : RectangleUIElement
    {
        ...
        public override async Task Load()
        {
            ...
            _aliasList = new List<ElementModel>(req.GetReturnedElementModels().Where(em => SessionController.Instance.ContentController.GetLibraryElementController(em?.LibraryId) != null));
            CreateAliasList();
            base.Load();
        }
