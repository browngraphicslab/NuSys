...
namespace NuSysApp
{
    public sealed partial class MultiSelectMenuView : UserControl
    {
        ...
        private async void GroupButtonOnClick(object sender, RoutedEventArgs routedEventArgs)
        {
            ...
            await SessionController.Instance.NuSysNetworkSession.ExecuteRequest(new CreateNewLibraryElementRequest(contentId, "", ElementType.Collection, "Nu Collection Beyotch!"));
