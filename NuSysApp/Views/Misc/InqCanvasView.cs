...
namespace NuSysApp
{
    ...
    public class InqCanvasView : Canvas
    {
        ...
        private HashSet<InqLineView> _strokes = new HashSet<InqLineView>();
        ...
        {
            InqCanvasViewModel vm = (InqCanvasViewModel) sender;
        ...
        public Rect PasteStrokes(InqLineView[] linesView)
        {

            double width = 0;
            double height = 0;
            foreach (var stroke in linesView)
            {
                var pl = new InqLineView();
        ...
        internal HashSet<InqLineView> Strokes
        {
            get
            {
                return _strokes;
